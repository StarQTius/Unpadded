...
/*!
  ...
  \details
    ...
    standard (<a href="https://en.cppreference.com/w/cpp/language/types#Character_types">Fundamental types - Character Types - cppreference</a>).
*/
using byte_t = unsigned char;

/*!
  \brief Definition of size_t as specified by the standard
  \details For futher information : <a href="https://en.cppreference.com/w/cpp/types/size_t">std::size_t - cppreference</a>.
*/
