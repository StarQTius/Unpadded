...
template<typename T, signed_mode Signed_Mode, detail::require<Signed_Mode == signed_mode::BUILTIN> = 0>
...
template<signed_mode Signed_Mode, typename T, detail::require<Signed_Mode == signed_mode::BUILTIN> = 0>
