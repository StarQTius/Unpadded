...
UPD_DETAIL_MAKE_DETECTOR(
    ...
    UPD_PACK(typename T),
    UPD_PACK(typename = decltype(write_as<endianess::LITTLE, signed_mode::TWOS_COMPLEMENT>(std::declval<T>(), nullptr),
                                 read_as<T, endianess::LITTLE, signed_mode::TWOS_COMPLEMENT>(nullptr))))
