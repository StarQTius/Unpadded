...
using require_input_invocable = require<has_signature<F, upd::byte_t()>::value, U>;

//! \brief Require the instances of the given type to be invocable on a byte
template<typename F, typename U = int>
using require_output_invocable = require<has_signature<F, void(upd::byte_t)>::value, U>;
