...
function(target_lintables TARGET)
  foreach(LINTABLE IN LISTS ARGN)
    __target_lintable(${TARGET} ${LINTABLE} ${TARGET})
  endforeach()
endfunction()

function(target_inherited_lintables TARGET)
  foreach(EXECUTABLE_TARGET IN LISTS ARGN)
    ...
    foreach(SOURCE IN LISTS TARGET_SOURCES)
      __target_lintable(${TARGET} ${SOURCE} ${EXECUTABLE_TARGET})
    endforeach()
  endforeach()
endfunction()

function(__target_lintable TARGET LINTABLE INHERIT_FROM)
  normalize_path(LINTABLE)
  properties_genex(LINTING_PROPERTIES_GENEX ${INHERIT_FROM}
                   ${LINTING_PROPERTIES})
  is_source_of_target_genex(IS_LINTABLE_SOURCE_GENEX ${INHERIT_FROM}
                            ${LINTABLE})
  ...
  add_custom_command(
    ...
    COMMAND $<TARGET_PROPERTY:${TARGET},LINTER_COMMAND> ${LINTABLE}
